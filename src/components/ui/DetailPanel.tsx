        ...
        <AnimatePresence>
          <>
            ...
            >
              ...
              <ScrollArea className="flex-1 min-w-0 [&_[data-radix-scroll-area-viewport]>div]:!block [&_[data-radix-scroll-area-viewport]>div]:!min-w-0">
                <div className="w-full min-w-0 overflow-x-hidden px-6 py-6">
                  <PersonDetailContent
                    person={person}
                    echoes={echoes}
      ...
      {isMobile && (
        <Drawer open={true} onOpenChange={(open) => { if (!open) onClose(); }}>
          <DrawerContent className="h-[92dvh] flex flex-col">
            ...
            <ScrollArea className="flex-1 min-w-0 overflow-x-hidden px-6 [&_[data-radix-scroll-area-viewport]>div]:!block [&_[data-radix-scroll-area-viewport]>div]:!min-w-0">
              <PersonDetailContent
                person={person}
                echoes={echoes}
                getEchoTarget={getEchoTarget}
